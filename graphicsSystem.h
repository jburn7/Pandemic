...
public:
	...
	void writeText(const Vector2D &targetLoc, const int fontSize, Font &font, const Color &color, const std::string &message, const Outline &background = Outline(), const Vector2D &scale = Vector2D(1, 1));
